      ...
      <div class="p-4 overflow-x-auto">
        <table class="w-full">
          ...
          <tr v-for="party in parties" :key="party.p_uuid">
            ...
            <td>{{ party.p_author }} <br> {{ party.p_date }}</td>
            <td>
  ...
  export default {
    data() {
      return {
        ...
        password: '',
        temp_party: {
          p_uuid: '4f30ca65-2853-4d45-af4a-cd2f23d34679',
          p_name: 'Name of Party1',
          p_address: 'jaipur',
          p_author: 'manu',
        ...
        parties: [
            ...
            {
              p_uuid: '35daf259-95d6-4fa5-a1b2-51665198829d',
              p_name: 'Name of Party2',
              p_address: 'lucknow',
              p_author: 'anubhav',
              p_email: 'test@test1.com',
              p_date: '30-30-2022',
