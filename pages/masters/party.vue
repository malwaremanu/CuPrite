            ...
            <tbody>
              ...
              >
                ...
                <td class="py-4 px-6">
                  {{ party.p_author }}
                  <br />
                  <span class="text-xs" v-text="$moment(party.p_date).fromNow()"></span>
                </td>
                <td class="py-4 px-6">
    ...
    >
      ...
      <div class="fixed z-10 inset-0 overflow-y-auto">
        <div class="w-full p-4">
          <div
            class="relative bg-gray-800 rounded-lg text-left overflow-hidden shadow-xl transform transition-all"
          >
    ...
    get_data() {
      ...
      axios
        ...
        .then(function (response) {
          console.log('this is get data', response.data.msg)
