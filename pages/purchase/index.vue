  ...
  <div class="bg-gray-900 min-h-screen">
        ...
        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
          ...
          <tbody>
            <tr
              ...
              class="cursor-pointer hover:bg-gray-200 dark:hover:bg-gray-600 bg-white border-b dark:bg-gray-800 dark:border-gray-700"
            >
              <th scope="row" class="py-4 px-6">
                <div
                  class="flex items-center justify-between font-medium text-gray-900 whitespace-nowrap dark:text-white"
                >{{ order.PO_NUMBER }}</div>
              </th>
              ...
              <td class="py-4 px-6 hidden">
                <div
                  @click="select_order(order)"
                  class="flex items-center gap-2 border border-gray-500 hover:border-gray-50 hover:text-gray-50 px-3 py-2 text-xs rounded-full cursor-pointer"
                >
                  <!-- <svg
                    class="w-4 h-4"
                    fill="none"
    ...
    <div v-show="!order_d">
      <div class="text-xl flex items-center justify-between gap-2 p-2">
        ...
        <div class="flex items-center justify-between gap-3">
          <div class="flex items-center text-xs uppercase gap-2">
            <span
              class="border border-gray-500 py-1 px-2 rounded-full hover:border-gray-50 cursor-pointer"
              @click="edit(show_po)"
              v-show="!to_edit"
            >Edit</span>
            ...
            <span
              class="border border-gray-300 py-1 bg-black px-2 rounded-full hover:border-gray-50 cursor-pointer"
      ...
      <div class="overflow-x-auto relative shadow-md rounded-lg lg:w-[90%] mx-auto">
        ...
        <div v-show="!is_saving" class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
          <div
            v-for="(value,key) in show_po"
            :key="key"
            class="hidden hover:bg-gray-200 dark:hover:bg-gray-600 bg-white border-b dark:bg-gray-800 dark:border-gray-700"
          >
            <p
              scope="row"
              class="font-medium px-4 pt-2 text-gray-900 whitespace-nowrap dark:text-white"
            >{{ key }}</p>
            <p class="px-6">
              <input
                type="text"
          ...
          <div class="flex items-center w-full">
            <div
              class="hover:bg-gray-200 w-full dark:hover:bg-gray-600 bg-white border-b dark:bg-gray-800 dark:border-gray-700"
            >
          ...
          >
            ...
            <div class="px-2 pb-2">
              <span class="font-semibold text-white">{{ show_po.SUPPLIER }}</span>
              <br />
            ...
            <p class="mt-1 text-sm font-normal text-gray-500 dark:text-gray-400">Browse a list of Flowbite products designed to help you work and play, stay organized, get answers, keep in touch, grow your business, and more.</p>
              ...
              <tbody>
                <tr
                  ...
                  :key="order"
                  class="cursor-pointer text-left hover:bg-gray-400 dark:hover:bg-gray-600 bg-white border-b dark:bg-gray-800 dark:border-gray-700"
                >
                  <th scope="row" class="py-4 px-6">
                    <div
                      class="flex items-center justify-between font-medium text-gray-900 whitespace-nowrap dark:text-white"
                    >{{ order_details.order }}</div>
                  </th>
                  <td class="py-4 px-6 text-xs">{{ order.PART_NUMBER }}</td>
                  <td class="py-4 px-6 text-xs w-90 TEXT-LEFT">{{ order.DESCRIPTION }}</td>
...
export default {
    data() {
        return {
            ...
            show_po: {
                DISCOUNT: 0,
                TVA: "16%",
                id: "073674e1-b630-4c3e-8a7f-0ce55bbabc1f",
                PO_DATE: "21-06-2022",
                AMOUNT: 7519.11,
                __createdtime__: 1659176217339,
                PO_NUMBER: "SM/22-557",
                TYPE: "PURCHASE",
                __updatedtime__: 1659176217339,
                TVA_AMOUNT: "1,203.06",
                SUPPLIER: "SERVICES MACHINERY TRUCKS",
                FROM: "SEMHKAT",
                GROSS_AMOUNT: "8,722.17",
            },
            order_d: true,
        };
    },
    ...
    methods: {
        fetch_data() {
            ...
            myHeaders.append("Authorization", "Basic bWFsd2FyZW1hbnU6TWFudUBoYXJwZXIx");
